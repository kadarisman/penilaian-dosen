            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box">
                        ...
                        <br>
                            <center>
                                <?php if($detail_ganjil) {?>
                                <h3 class="box-title" id="judul">Data Penilaian Pengajar Matakuliah <?=$mk->nama_matakuliah?><br>
                                Smester Ganjil tahun ajaran <?= date('Y')-1, ' / ', date('Y')?>
                                </h3>
                                <?php }else{ ?>
                                <h3 class="box-title" id="judul">Belum ada Penilaian untuk Matakuliah <?=$mk->nama_matakuliah?><br>
                                Smester Ganjil tahun ajaran <?= date('Y')-1, ' / ', date('Y')?>
                                </h3>
                                <?php } ?>
                            </center>
